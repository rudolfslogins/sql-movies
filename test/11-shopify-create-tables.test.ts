...
describe("Tables", () => {
    ...
    beforeAll(async () => (db = await Database.fromExisting("08", "09")));
    ...
    it("should have correct columns and column names", async done => {
        ...
        expect(apps).toEqual([
            ...
            { name: "description_raw", type: "text" },
    ...
    it("should have primary keys", async done => {
        ...
        expect(apps).toEqual([
            ...
            { name: "description_raw", primaryKey: false },
    ...
    it("should have not null constarints", async done => {
        ...
        expect(apps).toEqual([
            ...
            { name: "description_raw", notNull: true },
